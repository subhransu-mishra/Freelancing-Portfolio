  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 pt-32 pb-32 min-h-screen flex flex-col justify-center items-center text-center">
        ...
        <div 
          className="mt-6 flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm animate-fadeIn hover:bg-white/10 transition-colors duration-300"
          style={{ animationDelay: "0.8s" }}
        >
          <FaCheckCircle className="text-green-400 w-4 h-4" />
          <span className="text-xs md:text-sm text-white/90 font-medium tracking-wide">A MSME Approved Company</span>
        </div>
      </div>
    </div>
  );
